...
class Person {
    ...
    private String name;
    private Country country; // An Object reference of Country class
...
class Aggregation {
    ...
    public static void main(String args[]) {
        ...
        {
            Person user = new Person("Darth Vader", country); // passing country object to Person class constructor
            user.printDetails();
        }
