...
class Car {
    ...
    public Car(String col, int cap, int nt, int nod) {
        this.eObj = new Engine(cap); // Composition: Engine class object is part-of Car
        this.tObj = new Tires(nt); // Composition: Tires class object is part-of Car
        this.dObj = new Doors(nod); // Composition: Doors class object is part-of Car
